          ...
          {sports.map((sport) => (
            ...
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h2 className="text-4xl font-black uppercase italic tracking-tight text-slate-900 leading-none">{sport}</h2>
                  <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-2">Browse Archive</p>
                </div>
              </div>
